...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="logo"> <a href="indexo.php" title="Homepage"> <img src="images/logo3.png" alt="Educo International School"/><span></span></a></div>
...
<li class="sp-menu-item"><a  href="attendence/admin/index.php"  >Admin Login</a></li>
	<li class="sp-menu-item"><a  href="attendence/index.php"  >Teachers Login</a></li>
